...
export default function About() {
  return (
    <>
      ...
      {/* Add this useEffect to initialize AOS */}
      ...
      {/* Optionally, import AOS CSS in your main entry file or here */}
      ...
      <div className="max-w-4xl mx-auto px-4 flex flex-col items-center relative z-10">
        ...
        {/* Headings */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-2 text-white" data-aos="fade-up">
        ...
        {/* Description */}
        <p className="text-lg text-gray-300 text-center max-w-2xl mb-6" data-aos="fade-up" data-aos-delay="200">
