...
const services = [
  ...
  },
  {
    ...
    description:
      "Responsive web applications and mobile apps that engage users across all platforms.",
  ...
  },
  {
    ...
    title: "IT Consulting",
    description:
      "Strategic technology consulting to optimize your business processes and growth.",
    slug: "it-consulting",
    features: [
  ...
  },
  {
    ...
    description:
      "Transform your data into actionable insights with AI and machine learning.",
    slug: "data-analytics",
    features: [
  ...
  },
  {
    ...
    description:
      "Engage your audience with captivating animated video ads that drive brand awareness and conversions.",
  ...
  },
  {
    ...
    description:
      "From concept to prototype, we craft intuitive and visually stunning product designs that delight users.",
    slug: "product-design",
    features: [
      "UI/UX Design",
  ...
  },
  {
    ...
    title: "Video Editing",
    description:
      "Professional video editing services to create polished, impactful content that elevates your brand story.",
    slug: "video-editing",
    features: [
      "Cinematic Editing",
      "Color Grading",
...
export default function Services() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              business thrive in the digital age. From custom software
              development to AI-powered analytics, we've got you covered.
            </p>
            <a href="/contact">
      ...
      {/* Services Grid */}
      <div className=" py-20 min-h-screen w-full relative">
        {/* Azure Depths */}
        <div
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-3 py-1 bg-wofga-orange/20 text-wofga-orange rounded-full text-sm"
                        >
                          {tech}
                        </span>
                      ))}
            ...
            {[
              {
                ...
                title: "Discovery",
                description:
                  "We analyze your requirements, goals, and challenges to create a comprehensive project plan.",
              },
              {
                step: "02",
                title: "Design",
                description:
                  "Our team creates detailed wireframes, mockups, and technical specifications for your solution.",
              },
              {
                step: "03",
                title: "Development",
                description:
                  "We build your solution using best practices, with regular updates and feedback sessions.",
              },
              {
                step: "04",
                title: "Deployment",
              ...
              >
                <CardContent className="p-8 text-center">
                  <div className="text-4xl font-bold text-wofga-orange mb-4">
                    {phase.step}
                  </div>
